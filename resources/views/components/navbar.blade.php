        ...
        <li>
          <div class="nav-item dropdown hover-underline-animation">
              ...
              <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item text-white" href="{{route('categoryShow', compact('category'))}}"><x-categoriesLocale :category="$category"/></a></li>
                  @endforeach
              </ul>
          </div>
        </li>
          ...
          @auth
            <div class="nav-item dropdown mx-3">
              ...
              <div class="dropdown-menu dropdown-menu-end" id="userdropjs">
                <li>
                  <a href="#" class="hover-underline-animation dropdown-item userdropjs-item">Profile</a>
                </li>
