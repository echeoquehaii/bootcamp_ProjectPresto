          ...
          @auth
            <div class="nav-item dropdown mx-3">
              ...
              <div class="dropdown-menu dropdown-menu-end" id="userdropjs">
                <li>
                  <a href="#" class="hover-underline-animation dropdown-item userdropjs-item text-white">Profile</a>
                </li>
                @if(Auth::user()->is_revisor)
                  <li> 
                    <a href="{{route('indexRevisor')}}" id="noShow" class="hover-underline-animation dropdown-item userdropjs-item text-white">Zona revisore: <span>{{App\Models\Announce::toBeRevisionedCount()}}
                      <span class="visually-hidden">unread messages</span>
                    </span></a>
                  </li>             
                @endif
                <li><a class="me-5 hover-underline-animation dropdown-item userdropjs-item text-white" href="{{route('logout')}}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">Logout</a>
